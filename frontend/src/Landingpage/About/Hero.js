export default function Hero(){
    return(
        <div className="container">
            <div className="row text-center m-5 p-5 text-muted">
            ...
            <div className="row m-5 p-5">
                <div className="col-6 p-5 text-muted">
                    ...
                    <p>
                        ...
                        every year through our powerful ecosystem of investment 
                ...
                <div className="col-6 p-5 text-muted">
                    <p>
                        In addition, we run a number of popular 
                        open online educational and community 
                        initiatives to empower retail traders 
                        and investors.
                    </p>
                    <p>
                        Rainmatter, our fintech fund and incubator, 
